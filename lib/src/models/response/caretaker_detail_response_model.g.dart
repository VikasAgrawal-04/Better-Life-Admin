...
part of 'caretaker_detail_response_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CaretakerDetailsModel _$CaretakerDetailsModelFromJson(
        Map<String, dynamic> json) =>
    CaretakerDetailsModel(
      status: json['status'] as bool,
      appt: (json['data'] as List<dynamic>)
          .map((e) => CaretakerAppointment.fromJson(e as Map<String, dynamic>))
          .toList(),
      code: json['code'] as String,
      message: json['message'] as String,
    );

Map<String, dynamic> _$CaretakerDetailsModelToJson(
        CaretakerDetailsModel instance) =>
    <String, dynamic>{
...
CaretakerAppointment _$CaretakerAppointmentFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$CaretakerAppointmentToJson(
        CaretakerAppointment instance) =>
    <String, dynamic>{
